                                                ...
                                                <div class="modal-body">
                                                    @isset($roles)
                                                        @foreach ($roles as $role)
                                                            ...
                                                            <div class="form-check" style="padding:0px;">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="checkbox" name="roles[]" value="{{$role->id}}" id="participant{{$role->id}}">
                                                                    <span class="form-check-sign">{{$role->name}}</span>
                                                                    <div id="dropdown">
                                                                        <div class="dropdown-permission{{$role->id}}" id="dropdown-permission{{$role->id}}" style="display:none;">
                                                                            <label class="form-check-label">
                                                                                <input class="form-check-input" type="checkbox" name="reject[]" value="{{$role->id}}" id="participant{{$role->id}}">
                                                                                <span class="form-check-sign">Отказать</span>
                                                                            </label>
                                                                            <label class="form-check-label">
                                                                                <input class="form-check-input" type="checkbox" name="revision[]" value="{{$role->id}}" id="participant{{$role->id}}">
