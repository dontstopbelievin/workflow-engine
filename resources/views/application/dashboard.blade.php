                        ...
                        <table class="table">
                            ...
                            @foreach($processes as $process)
                                <tr class="shadow p-3 mb-5 rounded">
                                    <td class="text-left align-middle"><h4>{{$process->id}}</h4></td>
                                    <td class="text-middle align-middle"><h4>{{$process->name}}</h4></td>   
                                    <td class="text-center align-middle">
                                        <button class="rounded-circle bg-white" onclick="window.location='{{route('applications.index', ['process' => $process])}}'">
