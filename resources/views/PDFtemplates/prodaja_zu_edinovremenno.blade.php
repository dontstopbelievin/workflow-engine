                ...
                <div class="panel-body">
                    <div class="main-div">
                        ...
                        <p style="text-indent: 2em;">
                            ...
                            собственности на земельный участок площадью {{ $variable }} га, из них условная доля
                            {{ $variable }} га, для
                            эксплуатации «{{ $variable }}», кадастровой (оценочной) стоимостью «{{ $variable }}» тенге,
                            расположенный по адресу: город Нур-Султан, р-н «{{ $variable }}», улица {{ $variable }}, дом
                            {{ $variable }}, кв {{ $variable }}.
                        </p>
                        <p style="text-indent: 2em;">
                            2. Собственникам:<br />
