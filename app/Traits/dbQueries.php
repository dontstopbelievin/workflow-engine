...
trait dbQueries
{
    ...
    {
        $notInclude = ['id', 'process_id', 'status_id', 'user_id', 'reject_reason', 'reject_reason_from_spec_id', 'to_revision',
            'revision_reason','revision_reason_from_spec_id', 'revision_reason_to_spec_id', 'updated_at',
            'statuses', 'current_order', 'created_at', 'deadline_date'];
        $cols = DB::select(
